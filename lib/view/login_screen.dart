  ...
  Future<void> _getDeviceInfo() async {
    ...
    try {
      if (Platform.isAndroid) {
        ...
        // ✅ SAFE & ALLOWED
        info = androidInfo.id; // ANDROID_ID
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            SizedBox(height: 10),
                            InkWell(
                              onTap: isButtonDisabled ? null : handleLoginScreenTap,
                              child: Container(
                                height: 50,
                                width: 330,
              ...
              Padding(
                ...
                child: Material(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppConstant.btnBackColor,
